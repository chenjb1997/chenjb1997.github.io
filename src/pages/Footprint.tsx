...
const placeRegionLabels: Record<string, PlaceRegion> = {
  ...
  danxia: { label: "Guangdong", zhLabel: "广东" },
  heyuan: { label: "Guangdong", zhLabel: "广东" },
  shanwei: { label: "Guangdong", zhLabel: "广东" },
  shaoguan: { label: "Guangdong", zhLabel: "广东" },
  zhaoqing: { label: "Guangdong", zhLabel: "广东" },
  conghua: { label: "Guangdong", zhLabel: "广东" },
  zengcheng: { label: "Guangdong", zhLabel: "广东" },
  qingyuan: { label: "Guangdong", zhLabel: "广东" },
  foshan: { label: "Guangdong", zhLabel: "广东" },
  ...
  sanya: { label: "Hainan", zhLabel: "海南" },
  guilin: { label: "Guangxi", zhLabel: "广西" },
  yangshuo: { label: "Guangxi", zhLabel: "广西" },
  nanyang: { label: "Henan", zhLabel: "河南" },
  xian: { label: "Shaanxi", zhLabel: "陕西" },
  huashan: { label: "Shaanxi", zhLabel: "陕西" },
  qingdao: { label: "Shandong", zhLabel: "山东" },
  yantai: { label: "Shandong", zhLabel: "山东" },
  jinan: { label: "Shandong", zhLabel: "山东" },
  jiayuguan: { label: "Gansu", zhLabel: "甘肃" },
  dunhuang: { label: "Gansu", zhLabel: "甘肃" },
  zhangye: { label: "Gansu", zhLabel: "甘肃" },
  "yumen-pass": { label: "Gansu", zhLabel: "甘肃" },
  "dunhuang-yardang": { label: "Gansu", zhLabel: "甘肃" },
  shanghai: { label: "Shanghai", zhLabel: "上海" },
  nanjing: { label: "Jiangsu", zhLabel: "江苏" },
  suzhou: { label: "Jiangsu", zhLabel: "江苏" },
  xuzhou: { label: "Jiangsu", zhLabel: "江苏" },
  jinggangshan: { label: "Jiangxi", zhLabel: "江西" },
  wuhan: { label: "Hubei", zhLabel: "湖北" },
  yichang: { label: "Hubei", zhLabel: "湖北" },
  ...
  "wutai-mountain": { label: "Shanxi", zhLabel: "山西" },
  datong: { label: "Shanxi", zhLabel: "山西" },
  yinchuan: { label: "Ningxia", zhLabel: "宁夏" },
  xining: { label: "Qinghai", zhLabel: "青海" },
  "qinghai-lake": { label: "Qinghai", zhLabel: "青海" },
  ...
  dujiangyan: { label: "Sichuan", zhLabel: "四川" },
  hangzhou: { label: "Zhejiang", zhLabel: "浙江" },
  "qiandao-lake": { label: "Zhejiang", zhLabel: "浙江" },
  shaoxing: { label: "Zhejiang", zhLabel: "浙江" },
  ningbo: { label: "Zhejiang", zhLabel: "浙江" },
  "mount-putuo": { label: "Zhejiang", zhLabel: "浙江" },
  changsha: { label: "Hunan", zhLabel: "湖南" },
  shaoshan: { label: "Hunan", zhLabel: "湖南" },
  zhangjiajie: { label: "Hunan", zhLabel: "湖南" },
  "hong-kong": { label: "Hong Kong", zhLabel: "香港" },
  macau: { label: "Macau", zhLabel: "澳门" },

  atlanta: { label: "Georgia", zhLabel: "佐治亚州" },
  helen: { label: "Georgia", zhLabel: "佐治亚州" },
  macon: { label: "Georgia", zhLabel: "佐治亚州" },
  savannah: { label: "Georgia", zhLabel: "佐治亚州" },
  chattanooga: { label: "Tennessee", zhLabel: "田纳西州" },
  "great-smoky-mountains": { label: "Tennessee", zhLabel: "田纳西州" },
  orlando: { label: "Florida", zhLabel: "佛罗里达州" },
  "indian-rocks-beach": { label: "Florida", zhLabel: "佛罗里达州" },
  ...
  "grand-teton": { label: "Wyoming", zhLabel: "怀俄明州" },
  ...
  saipan: { label: "Northern Mariana Islands", zhLabel: "北马里亚纳群岛" },
  tinian: { label: "Northern Mariana Islands", zhLabel: "北马里亚纳群岛" },
  ...
  "point-pelee": { label: "Ontario", zhLabel: "安大略省" },
...
const places: FootprintPlace[] = [
  ...
  {
    id: "danxia",
    name: "Danxia Mountain",
    zhName: "丹霞山",
    country: "China",
    zhCountry: "中国",
    lat: 25.0318,
    lng: 113.7426,
    note: "Red sandstone cliffs and northern Guangdong mountain light.",
    zhNote: "红色砂岩山体与粤北山间光影。",
    photos: [],
  },
  {
    id: "heyuan",
    ...
    lat: 23.7437,
    lng: 114.7004,
    note: "Reservoir water, Hakka streets, and eastern Guangdong hills.",
    zhNote: "万绿湖水、客家街巷与粤东北山色。",
    photos: [],
  },
  {
    id: "shanwei",
    ...
    lat: 22.7862,
    lng: 115.3751,
    note: "Eastern Guangdong coast, bays, and sea breeze.",
    zhNote: "粤东海岸、海湾与海风。",
    photos: [],
  },
  {
    ...
    lat: 24.8104,
    lng: 113.5975,
    note: "Northern Guangdong city framed by mountains and rivers.",
    zhNote: "山水之间的粤北城市。",
    photos: [],
  },
  {
    ...
    lat: 23.0472,
    lng: 112.4651,
    note: "Star Lake, limestone peaks, and Lingnan old streets.",
    zhNote: "星湖、峰林与岭南老城街巷。",
    photos: [],
  },
  {
    ...
    lat: 23.5489,
    lng: 113.5865,
    note: "Hot springs, streams, and mountain-town air north of Guangzhou.",
    zhNote: "广州以北的温泉、溪流与山城空气。",
    photos: [],
  },
  {
    id: "zengcheng",
    ...
    lat: 23.2614,
    lng: 113.8109,
    note: "Lychee country, greenways, and eastern Guangzhou memories.",
    zhNote: "荔枝、绿道与广州东部记忆。",
    photos: [],
  },
  {
    ...
    lat: 23.6818,
    lng: 113.0561,
    note: "Rivers, mountains, and northern Pearl River Delta escapes.",
    zhNote: "山水之间的珠三角北缘去处。",
    photos: [],
  },
  {
    ...
    lat: 23.0215,
    lng: 113.1214,
    note: "Lingnan halls, old temples, and Pearl River Delta streets.",
    zhNote: "岭南祠堂、古庙与珠三角街巷。",
    photos: [],
  },
  {
    id: "zhanjiang",
  ...
  },
  {
    ...
    lat: 18.2528,
    lng: 109.5119,
    note: "Tropical coast, bays, and southern-island light.",
    zhNote: "热带海岸、海湾与南岛光线。",
    photos: [],
  },
  {
    ...
    lat: 25.2736,
    lng: 110.2902,
    note: "Karst peaks, rivers, and classic Guangxi scenery.",
    zhNote: "喀斯特峰林、江水与经典桂林山水。",
    photos: [],
  },
  {
    id: "yangshuo",
    ...
    lat: 24.7785,
    lng: 110.4966,
    note: "Li River bends, limestone peaks, and small-town evenings.",
    zhNote: "漓江弯道、峰林与小城夜色。",
    photos: [],
  },
  {
  ...
  },
  {
    ...
    lat: 34.4839,
    lng: 110.0841,
    note: "Steep ridges, Taoist temples, and Qinling mountain air.",
    zhNote: "险峻山脊、道观与秦岭山风。",
    photos: [],
  },
  {
  ...
  },
  {
    ...
    lat: 37.4638,
    lng: 121.4479,
    note: "Bohai coast, sea air, and northern Shandong light.",
    zhNote: "渤海海岸、海风与胶东光线。",
    photos: [],
  },
  {
    ...
    lat: 36.6512,
    lng: 117.1201,
    note: "Spring water, old city streets, and Shandong memories.",
    zhNote: "泉水、老城街巷与山东记忆。",
    photos: [],
  },
  {
  ...
  },
  {
    ...
    lat: 40.1421,
    lng: 94.6618,
    note: "Mogao Caves, Crescent Spring, and Mingsha Mountain in the desert.",
    zhNote: "沙漠中的莫高窟、月牙泉与鸣沙山。",
    photos: [
      {
  ...
  },
  {
    ...
    lat: 40.3532,
    lng: 93.8657,
    note: "Silk Road pass ruins on the Gobi plain.",
    zhNote: "戈壁平原上的丝路关隘遗址。",
    photos: [
      {
        src: "/footprint/yumen-pass-01.jpg",
        caption: "Yumen Pass ruins on the Gobi plain.",
        zhCaption: "戈壁平原上的玉门关遗址。",
      },
      {
        src: "/footprint/yumen-pass-02.jpg",
        caption: "Yumen Pass ruins under a wide desert sky.",
        zhCaption: "大漠天空下的玉门关遗址。",
      },
    ],
  },
  {
    ...
    lat: 40.479,
    lng: 93.087,
    note: "Yardang landforms and desert evening light near Dunhuang.",
    zhNote: "雅丹地貌与戈壁暮色。",
    photos: [
      {
  ...
  },
  {
    ...
    lat: 38.9813,
    lng: 100.0869,
    note: "Colorful Danxia hills and northwest desert light.",
    zhNote: "七彩丹霞山丘与西北戈壁光影。",
    photos: [
      {
        src: "/footprint/zhangye-01.jpg",
        caption: "Zhangye Danxia hills under a clear sky.",
        zhCaption: "晴空下的张掖七彩丹霞。",
      },
      {
        src: "/footprint/zhangye-02.jpg",
        caption: "Layered colors across Zhangye Danxia.",
        zhCaption: "张掖丹霞起伏的彩色山丘。",
      },
    ],
  },
  {
    ...
    lat: 31.2304,
    lng: 121.4737,
    note: "Meetings, contests, city walks, and a Huawei Lianqiu Lake campus stop.",
    zhNote: "会议、比赛、城市漫步，以及华为练秋湖基地一站。",
    photos: [
      {
      ...
      },
      {
        ...
        caption: "Huawei Lianqiu Lake campus across the water.",
        zhCaption: "水岸对面的华为练秋湖基地。",
      },
      {
        src: "/footprint/shanghai-02.jpg",
        caption: "Lakeside facade at Huawei Lianqiu Lake campus.",
        zhCaption: "华为练秋湖基地水岸建筑。",
      },
      {
        src: "/footprint/shanghai-03.jpg",
        caption: "Wide lake view at Huawei Lianqiu Lake campus.",
        zhCaption: "华为练秋湖基地的开阔湖景。",
      },
      {
        src: "/footprint/shanghai-04.jpg",
        caption: "Bridge view at Huawei Lianqiu Lake campus.",
        zhCaption: "华为练秋湖基地的桥与湖面。",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    lat: 31.2989,
    lng: 120.5853,
    note: "Canals, gardens, and quiet Jiangnan streets.",
    zhNote: "水巷、园林与安静的江南街道。",
    photos: [],
  },
  {
    id: "jinggangshan",
  ...
  },
  {
    ...
    lat: 30.6919,
    lng: 111.2864,
    note: "Yangtze River gorge city and Hubei mountain-water memories.",
    zhNote: "长江峡江城市与湖北山水记忆。",
    photos: [],
  },
  {
    id: "harbin",
  ...
  },
  {
    ...
    lat: 38.914,
    lng: 121.6147,
    note: "Harbor city, sea wind, and Liaodong Peninsula light.",
    zhNote: "海港城市、海风与辽东半岛的光。",
    photos: [],
  },
  {
    id: "lushun",
    ...
    lat: 38.812,
    lng: 121.267,
    note: "Lushun harbor history and peninsula coastline.",
    zhNote: "旅顺港口历史与半岛海岸线。",
    photos: [],
  },
  {
  ...
  },
  {
    ...
    lat: 39.005,
    lng: 113.596,
    note: "Temple courtyards and mountain valley light.",
    zhNote: "寺院庭院与山谷光影。",
    photos: [
      {
        src: "/footprint/wutai-mountain-01.jpg",
        caption: "Temple buildings at Mount Wutai.",
        zhCaption: "五台山寺院建筑。",
      },
      {
        src: "/footprint/wutai-mountain-02.jpg",
  ...
  },
  {
    ...
    lat: 40.0768,
    lng: 113.3001,
    note: "Northern Shanxi city and old frontier memories.",
    zhNote: "晋北城市与古代边塞记忆。",
    photos: [],
  },
  {
  ...
  },
  {
    ...
    lat: 36.6171,
    lng: 101.7782,
    note: "Qinghai gateway city and Kumbum Monastery.",
    zhNote: "青海门户城市与塔尔寺。",
    photos: [
      {
        src: "/footprint/xining-01.jpg",
        caption: "Kumbum Monastery in Xining.",
        zhCaption: "西宁塔尔寺。",
      },
    ],
  },
  {
    ...
    lat: 36.898,
    lng: 100.23,
    note: "Highland lake, open sky, and summer shoreline light.",
    zhNote: "高原湖泊、开阔天空与夏日湖岸光影。",
    photos: [
      {
        src: "/footprint/qinghai-lake-01.jpg",
        caption: "Qinghai Lake and distant clouds.",
        zhCaption: "青海湖与远处云影。",
      },
      {
        src: "/footprint/qinghai-lake-02.jpg",
        caption: "Rapeseed fields beside Qinghai Lake.",
        zhCaption: "青海湖畔的油菜花田。",
      },
      {
        src: "/footprint/qinghai-lake-03.jpg",
        caption: "Waves along the Qinghai Lake shore.",
        zhCaption: "青海湖岸边的湖浪。",
      },
      {
        src: "/footprint/qinghai-lake-04.jpg",
        caption: "Open shoreline at Qinghai Lake.",
        zhCaption: "青海湖开阔的湖岸。",
      },
    ],
  },
  ...
  },
  {
    ...
    lat: 30.5728,
    lng: 104.0668,
    note: "Tianfu Square, Jinjiang bridges, and Wuhou Shrine.",
    zhNote: "天府广场、锦江廊桥与武侯祠。",
    photos: [
      {
  ...
  },
  {
    ...
    lat: 31.001,
    lng: 103.6058,
    note: "Ancient waterworks and mountain-river engineering near Chengdu.",
    zhNote: "成都附近的古老水利工程与山水格局。",
    photos: [
      {
        src: "/footprint/dujiangyan-01.jpg",
        caption: "Dujiangyan waterworks near Chengdu.",
        zhCaption: "成都附近的都江堰水利工程。",
      },
    ],
  },
  {
    ...
    lat: 30.2741,
    lng: 120.1551,
    note: "Zhejiang years, snow, and lake-city light.",
    zhNote: "浙江岁月、雪景与湖城光影。",
    photos: [
      {
  ...
  },
  {
    ...
    lat: 29.608,
    lng: 119.031,
    note: "Island-dotted lake water in western Zhejiang.",
    zhNote: "浙西群岛散落的湖水。",
    photos: [
      {
  ...
  },
  {
    ...
    lat: 30.0303,
    lng: 120.5802,
    note: "Canals, old streets, and Jiangnan literary memories.",
    zhNote: "水巷、老街与江南文脉记忆。",
    photos: [],
  },
  {
    ...
    lat: 29.8683,
    lng: 121.544,
    note: "Port city, old streets, and East China Sea air.",
    zhNote: "港口城市、老街与东海海风。",
    photos: [],
  },
  {
    ...
    lat: 30.008,
    lng: 122.389,
    note: "Island temples and sea-facing Buddhist paths.",
    zhNote: "海岛寺庙与面向东海的礼佛山路。",
    photos: [],
  },
  {
    id: "dongguan",
  ...
  },
  {
    ...
    lat: 29.342,
    lng: 110.479,
    note: "Sandstone pillars, mountain paths, and Hunan mist.",
    zhNote: "砂岩峰林、山间步道与湘西云雾。",
    photos: [],
  },
  {
    id: "numazu",
  ...
  },
  {
    ...
    lat: 34.6937,
    lng: 135.5023,
    note: "Kansai city lights, food streets, and everyday travel memories.",
    zhNote: "关西城市灯火、食街与日常旅行记忆。",
    photos: [
      {
  ...
  },
  {
    ...
    lat: 34.7015,
    lng: -83.7316,
    note: "A Bavarian-style town in north Georgia with creekside mountain light.",
    zhNote: "佐治亚北部的德式小镇、溪流与山间天光。",
    photos: [
      {
        src: "/footprint/helen-01.jpg",
        caption: "Creekside trees in Helen.",
        zhCaption: "Helen 溪流边的树影。",
      },
      {
        src: "/footprint/helen-02.jpg",
        caption: "Riverside Bavarian-style building in Helen.",
        zhCaption: "Helen 河边的德式风格建筑。",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    lat: 35.6118,
    lng: -83.4895,
    note: "Clouds, ridgelines, and evening sky over the Smokies.",
    zhNote: "大烟山的云雾、山脊与傍晚天空。",
    photos: [
      {
  ...
  },
  {
    ...
    lat: 27.875,
    lng: -82.8517,
    note: "Indian Rocks Beach on the Gulf Coast of the Tampa Bay area.",
    zhNote: "坦帕湾地区墨西哥湾沿岸的 Indian Rocks Beach。",
    photos: [
      {
        src: "/footprint/indian-rocks-beach-01.jpg",
        caption: "A clear blue afternoon along Indian Rocks Beach.",
        zhCaption: "晴空下的 Indian Rocks Beach 海岸。",
      },
      {
        src: "/footprint/indian-rocks-beach-02.jpg",
        caption: "Sunlight over the Gulf of Mexico at Indian Rocks Beach.",
        zhCaption: "阳光洒在 Indian Rocks Beach 的墨西哥湾海面。",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    lat: 43.4799,
    lng: -110.7624,
    note: "Jackson town square and nearby road-trip stops.",
    zhNote: "杰克逊镇广场与周边自驾停留点。",
    photos: [
      {
  ...
  },
  {
    ...
    lat: 43.7904,
    lng: -110.6818,
    note: "Teton peaks, lakeshore light, and national park road-trip views.",
    zhNote: "大蒂顿群峰、湖岸天光与国家公园自驾风景。",
    photos: [
      {
        src: "/footprint/grand-teton-01.jpg",
        caption: "Grand Teton peaks above the lake.",
        zhCaption: "湖面上方的大蒂顿群峰。",
      },
      {
        src: "/footprint/grand-teton-02.jpg",
        caption: "Lakeshore light near Grand Teton.",
        zhCaption: "大蒂顿湖岸边的开阔天光。",
      },
      {
        src: "/footprint/grand-teton-03.jpg",
        caption: "Mountain light near Grand Teton.",
        zhCaption: "大蒂顿附近的山间云光。",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    lat: 15.1778,
    lng: 145.7509,
    note: "Northern Mariana island beaches and Pacific light.",
    zhNote: "北马里亚纳群岛的海滩与太平洋天光。",
    photos: [],
  },
  {
    id: "tinian",
    ...
    lat: 14.9992,
    lng: 145.6357,
    note: "Quiet island roads and Northern Mariana shoreline.",
    zhNote: "安静的海岛道路与北马里亚纳海岸线。",
    photos: [],
  },
  {
    id: "miami",
...
const initialCenter: MapCenter = [155, 31];
