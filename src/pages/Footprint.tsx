...
const placeRegionLabels: Record<string, PlaceRegion> = {
  ...
  toyama: { label: "Toyama", zhLabel: "富山县" },
...
const places: FootprintPlace[] = [
  ...
  },
  {
    ...
    lat: 36.6953,
    lng: 137.2113,
    note: "Doraemon, rice fields, and quiet Toyama light.",
    zhNote: "哆啦A梦、稻田与富山的安静夏光。",
    photos: [
      {
        src: "/footprint/toyama-01.jpg",
        caption: "Doraemon friends in Toyama Prefecture.",
        zhCaption: "富山县里的哆啦A梦伙伴们。",
      },
      {
        src: "/footprint/toyama-02.jpg",
        caption: "Green rice fields on a Toyama summer day.",
        zhCaption: "富山夏日的稻田与民居。",
      },
    ],
  },
  {
    ...
    lat: 36.7541,
    lng: 137.0257,
    note: "Amaharashi Coast and the Himi Line by the sea.",
    zhNote: "雨晴海岸与沿海的冰见线。",
    photos: [
      {
