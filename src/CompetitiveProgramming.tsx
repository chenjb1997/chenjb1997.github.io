...
const CompetitiveProgramming = () => {
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold mb-6">Competitive Programming</h1>
      
      <div className="prose max-w-none">
        <p className="mb-4 text-lg">
          I started doing competitive programming since high school. I received a Bronze Medal in National Olympiad in
          Informatics (NOI) in 2015. Then I joined the Competitive Programming Team of Zhejiang University and
          competed as the team leader of Team Legilimens (2017-2019) and the student co-coach (2018-2021). During my
          undergraduate life, I won 12 gold medals in International Collegiate Programming Contest (ICPC), China
          Collegiate Programming Contest (CCPC) series competitions including the very first domestic ICPC Regional
          Champion of Zhejiang University in 2017. On behalf of Zhejiang University, I participated in ICPC World Finals
          2018 (Beijing).
        </p>

        <p className="mb-4 text-lg">
          During my first year in Georgia Tech, I won the Champion of the 2020 ICPC Southeast USA Regional Contest
          and Second Runner-up in the 2021 North America Championship. I participated in ICPC World Finals 2022
          (Luxor) as a two-person team and ranked 13th place.
        </p>

        <p className="mb-4 text-lg">
          I am an International Grandmaster on <a href="https://codeforces.com/profile/chenjb" className="text-blue-600 hover:text-blue-800">Codeforces</a> (Max Rating 2735).
        </p>

        <p className="mb-4 text-lg">
          I am a member of <a href="https://sua.ac/" className="text-blue-600 hover:text-blue-800">SUA Programming Competitions Problems Setter Team</a>.
        </p>

        <p className="mb-8 text-lg">
          I am the co-founder and co-president of the <a href="https://ucup.ac" className="text-blue-600 hover:text-blue-800">Universal Cup</a>, which is an organization dedicated to offering training
          resources for competitive programming teams. In the previous season, over 900 teams from more than 500
          affiliations all over the world, registered and participated in a total of 28 stages, encompassing contests from
          Asia, Europe, and America. The current season is open for registration now. We will be hosting the 2025
          Universal Cup Finals in Dongguan, China, on February 19-24, 2025.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4">Coaching</h2>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">Problem Setting and Judging</h2>
        <ul className="list-disc pl-5 space-y-2 text-lg">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">Others</h2>
        <ul className="list-disc pl-5 space-y-2 text-lg">
          <li>
            <a href="http://keystone.wiki/" className="text-blue-600 hover:text-blue-800">Keystone Wiki</a> (Feel free contact me for the authority)
          </li>
        </ul>
      </div>
    </div>
