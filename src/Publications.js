...
const Publications = () => {
    ...
    const talks = [];  // Populate this array similarly if needed
...
sectionContainer: {  // New style to ensure uniform styling of sections
    width: '100%',
    maxWidth: '800px', // Ensure all sections are the same width
    display: 'flex',
    flexDirection: 'column',
  ...
  heading: {
    fontSize: '30px',  // Slightly larger font size
    fontWeight: 'normal',  // Ensure it's not bolded
    fontStyle: 'normal',  // Keeping as normal
    color: '#333'
  },
  publication: {
      display: 'flex',
      flexDirection: 'column',  // Organizes the title, authors, year, and abstract vertically
      alignItems: 'flex-start', // Aligns text to the start of the flex container
      marginBottom: '15px',
      paddingBottom: '10px',
      borderBottom: '1px solid #eee',
      maxWidth: '800px', // Restricts maximum width to keep the text more vertical
  },
  title: {
      fontSize: '20px',
      fontWeight: 'normal',
